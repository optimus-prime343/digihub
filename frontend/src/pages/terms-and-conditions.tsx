  ...
  return (
    <div className='prose max-w-none dark:prose-invert'>
      ...
      <p>
        ...
        of Digihub's Website, located at https://www.digihub.vercel.app.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use Digihub if you do not agree to take
      ...
      <p>
        We employ the use of cookies. By accessing Digihub, you agreed to use
        cookies in agreement with the Digihub's Privacy Policy.{' '}
      </p>
      ...
      <p>
        ...
        Digihub for your own personal use subjected to restrictions set in these
      ...
      <p>
        ...
        Digihub does not filter, edit, publish or review Comments prior to their
        presence on the website. Comments do not reflect the views and opinions
        of Digihub,its agents and/or affiliates. Comments reflect the views and
        opinions of the person who post their views and opinions. To the extent
        permitted by applicable laws, Digihub shall not be liable for the
      ...
      <p>
        You hereby grant Digihub a non-exclusive license to use, reproduce, edit
      ...
      <p>
        ...
        the hyperlink compensates the absence of Digihub; and (d) the link is in
      ...
      <p>
        ...
        e-mail to Digihub. Please include your name, your organization name,
      ...
      <p>
        No use of Digihub's logo or other artwork will be allowed for linking
