...
import { SignUpMerchantPayload } from '~types/user'

const initialValues: SignUpMerchantPayload = {
  firstName: '',
  lastName: '',
  email: '',
  username: '',
...
const RegisterMerchant = () => {
  ...
  const { getFieldProps, handleSubmit, touched, errors } =
    useFormik<SignUpMerchantPayload>({
      initialValues,
      ...
      onSubmit: async values => {
        ...
        signup(data, () => router.push('/auth/login'))
      },
    })
  const getFieldError = (fieldName: keyof SignUpMerchantPayload) => {
